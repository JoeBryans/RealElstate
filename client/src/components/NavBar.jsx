...
const NavBar = () => {
  ...
  const user = false;
  return (
    <div className="bg-blue-800 relative text-white py-3">
      <div className="flex items-center justify-between  sm:justify-around px-5 sm:px-0">
        ...
        >
          ...
          <Link to="/property" className="  text-2xl text-white font-semibold ">
            Properties
          </Link>
          {user ? (
            <Link to="/account" className=" text-2xl text-white font-semibold ">
              Account
            </Link>
          ) : (
